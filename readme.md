...
| Filename | Latent Variables | Skill |
| :--- | :--- | :--- |
| novelex6 | -1.48 -3.15 -0.93 -1.133 | Aerial bound (two bounds) |
...
| novelex4 | 0 0 0 1 | Some kind of trot and bound mix (16000) |

## 3.4 Tripedal Walking
| Filename | Latent Variables | Skill |
| :--- | :--- | :--- |
| novelex6 | 1 0 0 1 | Original trot becomes a new skill: walking with right front leg lifted |
| novelex5 | 0 0 0 1 | New skill: front bound, rear trot (effect not very obvious) |
| novelex3 | 0.21 2.16 1.23 0.83 | Left front leg lifted, tripedal walking |
| novelex2 | 2.72 3.10 -0.81 0.38 | Right front leg lifted (rear left also involved) |
...
| novelex2 | -0.88 2.5 -0.81 -2.42 | Walking sideways with left legs (also -0.49 1.79 -3.91 -0.15) |
